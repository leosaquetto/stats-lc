    ...
    <HashRouter>
      ...
      <AnimatePresence>
        {(!featuredUserId || !allUsers.some(user => user.id === featuredUserId)) && allUsers.length > 0 && (
          <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-black/30 backdrop-blur-xl p-4 pb-20">
            <motion.div
            ...
            >
              ...
              <div className="flex justify-center gap-2">
                {[...allUsers].sort((a, b) => a.name.localeCompare(b.name)).map((user, index) => (
                  ...
                  >
                    <motion.div
                      className="absolute inset-0 rounded-2xl bg-orange-500/20 blur-xl opacity-0 group-hover:opacity-100 transition-opacity"
                    />
