...
14. Modo conservador reduz loops, nao elimina entradas finitas essenciais.
   ...
   - Na entrada em fileirinha do RankingSummary, o wrapper externo ja nasce no slot final de `36px`; somente o wrapper interno parte visualmente do primeiro slot e se distribui em sequencia. A saida faz o caminho inverso.
