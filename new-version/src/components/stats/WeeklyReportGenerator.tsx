  ...
  return (
    <>
      <button 
        ...
        className="glass-card flex items-center justify-between p-5 w-full group hover:bg-white/[0.04] active:scale-[0.98] transition-all border-orange-500/20 shadow-xl relative overflow-hidden"
      >
        {/* Animated background hint */}
        <div className="absolute top-0 right-0 w-24 h-24 bg-orange-500/5 blur-2xl rounded-full -mr-12 -mt-12 group-hover:bg-orange-500/20 transition-all" />
        ...
        <div className="flex items-center gap-4 relative z-10">
            <div className="h-12 w-12 rounded-2xl bg-gradient-to-br from-orange-500 to-orange-400 flex items-center justify-center shadow-lg shadow-orange-500/20 group-hover:scale-110 group-hover:rotate-3 transition-transform">
                {isGenerating ? <Loader2 className="h-6 w-6 text-black animate-spin" /> : <Sparkles className="h-6 w-6 text-black" />}
            </div>
        ...
        <div className="h-9 w-9 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center group-hover:bg-orange-500 group-hover:border-orange-500 transition-all relative z-10">
